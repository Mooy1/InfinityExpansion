...
public final class Materials {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        registerSmeltery(INFINITY_SINGULARITY, EARTH_SINGULARITY, MYTHRIL, FORTUNE_SINGULARITY, MAGIC_SINGULARITY, VOID_INGOT, METAL_SINGULARITY);
        ...
        register(Categories.INFINITY_CHEAT, INFINITE_CIRCUIT, InfinityWorkbench.TYPE, new ItemStack[] {
                MACHINE_CIRCUIT, INFINITY_SINGULARITY, MACHINE_CIRCUIT, MACHINE_CIRCUIT, INFINITY_SINGULARITY, MACHINE_CIRCUIT,
                VOID_INGOT, MACHINE_CIRCUIT, VOID_INGOT, VOID_INGOT, MACHINE_CIRCUIT, VOID_INGOT,
                INFINITY_SINGULARITY, VOID_INGOT, MACHINE_CIRCUIT, MACHINE_CIRCUIT, VOID_INGOT, INFINITY_SINGULARITY,
                INFINITY_SINGULARITY, VOID_INGOT, MACHINE_CIRCUIT, MACHINE_CIRCUIT, VOID_INGOT, INFINITY_SINGULARITY,
                VOID_INGOT, MACHINE_CIRCUIT, VOID_INGOT, VOID_INGOT, MACHINE_CIRCUIT, VOID_INGOT,
                MACHINE_CIRCUIT, INFINITY_SINGULARITY, MACHINE_CIRCUIT, MACHINE_CIRCUIT, INFINITY_SINGULARITY, MACHINE_CIRCUIT
        });
        register(Categories.INFINITY_CHEAT, INFINITE_CORE, InfinityWorkbench.TYPE, new ItemStack[] {
                MACHINE_PLATE, MACHINE_CORE, INFINITY_SINGULARITY, INFINITY_SINGULARITY, MACHINE_CORE, MACHINE_PLATE,
                MACHINE_CORE, MACHINE_PLATE, MACHINE_CIRCUIT, MACHINE_CIRCUIT, MACHINE_PLATE, MACHINE_CORE,
                INFINITY_SINGULARITY, MACHINE_CIRCUIT, INFINITY_SINGULARITY, INFINITY_SINGULARITY, MACHINE_CIRCUIT, INFINITY_SINGULARITY,
                INFINITY_SINGULARITY, MACHINE_CIRCUIT, INFINITY_SINGULARITY, INFINITY_SINGULARITY, MACHINE_CIRCUIT, INFINITY_SINGULARITY,
                MACHINE_CORE, MACHINE_PLATE, MACHINE_CIRCUIT, MACHINE_CIRCUIT, MACHINE_PLATE, MACHINE_CORE,
                MACHINE_PLATE, MACHINE_CORE, INFINITY_SINGULARITY, INFINITY_SINGULARITY, MACHINE_CORE, MACHINE_PLATE
        });
