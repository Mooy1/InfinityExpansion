...
public final class MobData {
    ...
    public static final SlimefunItemStack COD = MobDataCard.create("Cod", MobDataTier.PASSIVE);
    public static final SlimefunItemStack FROG = MobDataCard.create("Frog", MobDataTier.PASSIVE);
    ...
    public static final SlimefunItemStack RAW_ORE = MobDataCard.create("Raw Ores", MobDataTier.MINI_BOSS);
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        }).addDrop(Material.ROTTEN_FLESH, 2, 1).register(plugin);
        new MobDataCard(SLIME, MobDataTier.NEUTRAL, new ItemStack[] {
                ...
                new ItemStack(Material.SLIME_BLOCK, 16), new ItemStack(Material.LIME_DYE, 16), new ItemStack(Material.SLIME_BLOCK, 16)
        }).addDrop(Material.SLIME_BALL, 2, 1).register(plugin);
        new MobDataCard(MAGMA_CUBE, MobDataTier.NEUTRAL, new ItemStack[] {
                ...
                new ItemStack(Material.MAGMA_BLOCK, 64), new ItemStack(Material.MAGMA_CREAM, 16), new ItemStack(Material.MAGMA_BLOCK, 64)
        }).addDrop(Material.MAGMA_CREAM, 2,1).register(plugin);
        new MobDataCard(COW, MobDataTier.PASSIVE, new ItemStack[] {
                ...
                new ItemStack(Material.LEATHER, 64), new ItemStack(Material.BEEF, 64), new ItemStack(Material.LEATHER, 64)
        }).addDrop(Material.LEATHER, 2,1).addDrop(Material.BEEF, 2, 1).register(plugin);
        new MobDataCard(SHEEP, MobDataTier.PASSIVE, new ItemStack[] {
                ...
                new ItemStack(Material.WHITE_WOOL, 64), new ItemStack(Material.MUTTON, 64), new ItemStack(Material.WHITE_WOOL, 64)
        }).addDrop(Material.WHITE_WOOL, 2,1).addDrop(Material.MUTTON, 2, 1).addDrop(Material.PINK_WOOL, 2,10000).register(plugin);
        new MobDataCard(SPIDER, MobDataTier.HOSTILE, new ItemStack[] {
                ...
                new ItemStack(Material.COBWEB, 8), new ItemStack(Material.STRING, 64), new ItemStack(Material.COBWEB, 8)
        }).addDrop(Material.STRING, 2,1).addDrop(Material.SPIDER_EYE, 2,2).register(plugin);
        ...
        }).addDrop(Material.BONE, 2,1).addDrop(Material.ARROW, 2,3).register(plugin);
        ...
        }).addDrop(Material.COAL, 2, 1).addDrop(Material.BONE, 2,3).addDrop(Material.WITHER_SKELETON_SKULL, 2,15).register(plugin);
        new MobDataCard(ENDERMEN, MobDataTier.ADVANCED, new ItemStack[] {
                ...
                new ItemStack(Material.ENDER_EYE, 16), new ItemStack(Material.OBSIDIAN, 64), new ItemStack(Material.ENDER_EYE, 16)
        }).addDrop(Material.ENDER_PEARL, 2,1).register(plugin);
        new MobDataCard(CREEPER, MobDataTier.HOSTILE, new ItemStack[] {
                ...
                new ItemStack(Material.TNT, 16), new ItemStack(Material.GREEN_DYE, 64), new ItemStack(Material.TNT, 16)
        }).addDrop(Material.GUNPOWDER, 2,1).register(plugin);
        new MobDataCard(GUARDIAN, MobDataTier.HOSTILE, new ItemStack[] {
                ...
                .addDrop(Material.COD, 2,3).addDrop(Material.SPONGE, 2,40).register(plugin);
        ...
        }).addDrop(Material.CHICKEN, 2,1).addDrop(Material.FEATHER, 2,2).register(plugin);
        new MobDataCard(IRON_GOLEM, MobDataTier.ADVANCED, new ItemStack[] {
                ...
                new ItemStack(Material.IRON_BLOCK, 64), new ItemStack(Material.PUMPKIN, 16), new ItemStack(Material.IRON_BLOCK, 64)
        }).addDrop(Material.IRON_INGOT, 4, 1).addDrop(Material.POPPY, 2,3).addDrop(SlimefunItems.BASIC_CIRCUIT_BOARD, 3).register(plugin);
        new MobDataCard(BLAZE, MobDataTier.ADVANCED, new ItemStack[] {
                ...
                new ItemStack(Material.MAGMA_BLOCK, 64), new ItemStack(Material.BLAZE_ROD, 64), new ItemStack(Material.MAGMA_BLOCK, 64)
        }).addDrop(Material.BLAZE_ROD, 2,1).register(plugin);
        ...
        }).addDrop(Material.NETHER_STAR, 2,1).addDrop(SlimefunItems.COMPRESSED_CARBON, 8, 2).addDrop(Material.WITHER_ROSE, 1,1).register(plugin);
        ...
        new MobDataCard(BEE, MobDataTier.NEUTRAL, new ItemStack[] {
                ...
                new ItemStack(Material.HONEYCOMB_BLOCK, 16), new ItemStack(Material.HONEY_BLOCK, 16), new ItemStack(Material.HONEYCOMB_BLOCK, 16)
        }).addDrop(Material.HONEYCOMB, 2,1).register(plugin);
        ...
        }).addDrop(Material.EMERALD, 2,1).register(plugin);
        ...
        }).addDrop(Material.SUGAR, 2,1).addDrop(Material.REDSTONE, 2,1)
                .addDrop(Material.GLASS_BOTTLE, 2,1).addDrop(Material.GLOWSTONE_DUST, 2,1).register(plugin);



        // NEW CARDS
        new MobDataCard(RAW_ORE, MobDataTier.BOSS, new ItemStack[] {
            new ItemStack(Material.RAW_IRON_BLOCK, 64), new ItemStack(Material.RAW_IRON_BLOCK, 64), new ItemStack(Material.RAW_IRON_BLOCK, 64),
            new ItemStack(Material.RAW_COPPER_BLOCK, 64), EMPTY_DATA_CARD, new ItemStack(Material.RAW_COPPER_BLOCK, 64),
            new ItemStack(Material.RAW_GOLD_BLOCK, 64), new ItemStack(Material.RAW_GOLD_BLOCK, 64), new ItemStack(Material.RAW_GOLD_BLOCK, 64)
        }).addDrop(Material.RAW_COPPER, 4, 1).addDrop(Material.RAW_GOLD, 4, 1).addDrop(Material.RAW_IRON, 4, 1).register(plugin);
        new MobDataCard(COD, MobDataTier.PASSIVE, new ItemStack[] {
            new ItemStack(Material.COD, 64), new ItemStack(Material.COD, 64), new ItemStack(Material.COD, 64),
            new ItemStack(Material.FISHING_ROD), EMPTY_DATA_CARD, new ItemStack(Material.FISHING_ROD),
            new ItemStack(Material.COD, 64), new ItemStack(Material.COD, 64), new ItemStack(Material.COD, 64)
        }).addDrop(Material.COD, 2, 1).register(plugin);
        new MobDataCard(FROG, MobDataTier.PASSIVE, new ItemStack[] {
            new ItemStack(Material.FROGSPAWN, 64), new ItemStack(Material.FROGSPAWN, 64), new ItemStack(Material.FROGSPAWN, 64),
            new ItemStack(Material.MAGMA_CREAM, 64), EMPTY_DATA_CARD, new ItemStack(Material.MAGMA_CREAM, 64),
            new ItemStack(Material.PEARLESCENT_FROGLIGHT, 64), new ItemStack(Material.OCHRE_FROGLIGHT, 64), new ItemStack(Material.VERDANT_FROGLIGHT, 64)
        }).addDrop(Material.PEARLESCENT_FROGLIGHT, 2, 1).addDrop(Material.OCHRE_FROGLIGHT, 2, 1).addDrop(Material.VERDANT_FROGLIGHT, 2, 1).register(plugin);
        new MobDataCard(SQUID, MobDataTier.PASSIVE, new ItemStack[] {
            new ItemStack(Material.INK_SAC, 64), new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.INK_SAC, 64),
            new ItemStack(Material.SEA_PICKLE, 64), EMPTY_DATA_CARD, new ItemStack(Material.KELP, 64),
            new ItemStack(Material.INK_SAC, 64), new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.INK_SAC, 64)
        }).addDrop(Material.INK_SAC, 2, 1).register(plugin);
        new MobDataCard(TURTLE, MobDataTier.PASSIVE, new ItemStack[] {
            new ItemStack(Material.BOWL, 64), new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.TURTLE_EGG, 64),
            new ItemStack(Material.SEAGRASS, 64), EMPTY_DATA_CARD, new ItemStack(Material.SEAGRASS, 64),
            new ItemStack(Material.TURTLE_EGG, 64), new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.BOWL, 64)
        }).addDrop(Material.TURTLE_EGG, 2, 1).addDrop(Material.TURTLE_HELMET, 1000).register(plugin);
    }
